...
Original file is located at
    https://colab.research.google.com/drive/1NAGY2qJLPFHIu839l-r383Bz0Tmj8AQj
"""
...
class RecommendationVector(nn.Module, BaseEstimator, ClassifierMixin):
    def __init__(self):
        ...
        self.optimizer = optim.Adam([self.BU, self.BI,self.WPU,self.WPI, *self.output_layer.parameters()], lr=Config.lr)
        self.trained = False
    ...
    def forward(self, user_ids, item_ids):
        ...
        pred = self.global_mean + bias_user + bias_item + bias_vector
